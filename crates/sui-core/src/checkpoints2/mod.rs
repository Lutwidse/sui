...
use sui_types::messages_checkpoint::{
    ...
    CheckpointSummary, SignedCheckpointData,
};
...
struct CheckpointStoreTables {
    ...
    pending_signatures: DBMap<(CheckpointSequenceNumber, u64), SignedCheckpointData>,
...
impl CheckpointService {
    ...
    pub fn notify_checkpoint_signature(&self, info: Box<SignedCheckpointData>) -> SuiResult {
...
mod tests {
    ...
    pub async fn checkpoint_builder_test() {
        ...
        checkpoint_service
            .notify_checkpoint_signature(Box::new(SignedCheckpointData { summary: c2ss }))
            .unwrap();
        checkpoint_service
            .notify_checkpoint_signature(Box::new(SignedCheckpointData { summary: c1ss }))
            .unwrap();
